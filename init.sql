...
INSERT IGNORE INTO cours (titre, description, category, youtube_vd_url, enseignant_id) VALUES
('Python Fundamentals', 'Learn the basics of Python programming', 'Python', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 1),
('Advanced Python', 'Deep dive into advanced Python concepts', 'Python', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 1),
('Python Data Science', 'Use Python for data analysis and ML', 'Python', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 1),
('AWS Cloud Fundamentals', 'Introduction to Amazon Web Services', 'Cloud Computing', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 2),
('Azure Cloud Services', 'Microsoft Azure cloud platform overview', 'Cloud Computing', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 2),
('Google Cloud Platform', 'Google Cloud Platform services overview', 'Cloud Computing', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 2),
('Docker & Containerization', 'Master Docker and containers', 'DevOps', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 3),
('CI/CD with Jenkins', 'Continuous integration/deployment with Jenkins', 'DevOps', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 3),
('Kubernetes Orchestration', 'Kubernetes orchestration basics', 'DevOps', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 3),
('Data Structures Fundamentals', 'Learn arrays, lists, stacks, queues', 'Algorithms', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 4),
('Sorting & Searching Algorithms', 'Sorting and search algorithm techniques', 'Algorithms', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 4),
('Graph Algorithms', 'Graph theory algorithms and traversal', 'Algorithms', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 4),
('HTML & CSS Fundamentals', 'Building responsive web pages', 'Web Development', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 5),
('JavaScript & DOM Manipulation', 'Client-side programming with JS', 'Web Development', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 5),
('React.js Framework', 'Modern web applications with React', 'Web Development', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 5),
('SQL Database Design', 'Database design and normalization', 'Database', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 6),
('NoSQL with MongoDB', 'Document database with MongoDB', 'Database', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 6),
('Redis Caching', 'In-memory caching strategies with Redis', 'Database', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 6),
('Network Security Basics', 'Network security fundamentals', 'Cybersecurity', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 7),
('Ethical Hacking', 'Penetration testing and vulnerability assessment', 'Cybersecurity', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 7),
('Cryptography Fundamentals', 'Encryption, hashing, and security protocols', 'Cybersecurity', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 7),
('React Native Basics', 'Cross-platform mobile development', 'Mobile Development', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 8),
('iOS Development with Swift', 'Native iOS app development with Swift', 'Mobile Development', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 8),
('Android Development', 'Native Android app development', 'Mobile Development', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 8);
