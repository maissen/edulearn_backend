...
CREATE TABLE IF NOT EXISTS cours (
    ...
    youtube_vd_url VARCHAR(500) NOT NULL,
...
-- Finished courses - tracks courses completed by students
CREATE TABLE IF NOT EXISTS finished_courses (
    ...
    FOREIGN KEY (etudiant_id) REFERENCES etudiants(id) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (cours_id) REFERENCES cours(id) ON DELETE CASCADE ON UPDATE CASCADE,
    UNIQUE KEY unique_completion (etudiant_id, cours_id),
    INDEX idx_etudiant_id (etudiant_id),
    INDEX idx_cours_id (cours_id),
...
INSERT IGNORE INTO cours (titre, description, category, youtube_vd_url, image_url, enseignant_id) VALUES
('Python Fundamentals', 'Learn the basics of Python programming', 'Python', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 1),
('Advanced Python', 'Deep dive into advanced Python concepts', 'Python', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 1),
('Python Data Science', 'Use Python for data analysis and ML', 'Python', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 1),
('AWS Cloud Fundamentals', 'Introduction to Amazon Web Services', 'Cloud Computing', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 2),
('Azure Cloud Services', 'Microsoft Azure cloud platform overview', 'Cloud Computing', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 2),
('Google Cloud Platform', 'Google Cloud Platform services overview', 'Cloud Computing', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 2),
('Docker & Containerization', 'Master Docker and containers', 'DevOps', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 3),
('CI/CD with Jenkins', 'Continuous integration/deployment with Jenkins', 'DevOps', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 3),
('Kubernetes Orchestration', 'Kubernetes orchestration basics', 'DevOps', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 3),
('Data Structures Fundamentals', 'Learn arrays, lists, stacks, queues', 'Algorithms', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 4),
('Sorting & Searching Algorithms', 'Sorting and search algorithm techniques', 'Algorithms', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 4),
('Graph Algorithms', 'Graph theory algorithms and traversal', 'Algorithms', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 4),
('HTML & CSS Fundamentals', 'Building responsive web pages', 'Web Development', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 5),
('JavaScript & DOM Manipulation', 'Client-side programming with JS', 'Web Development', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 5),
('React.js Framework', 'Modern web applications with React', 'Web Development', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 5),
('SQL Database Design', 'Database design and normalization', 'Database', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 6),
('NoSQL with MongoDB', 'Document database with MongoDB', 'Database', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 6),
('Redis Caching', 'In-memory caching strategies with Redis', 'Database', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 6),
('Network Security Basics', 'Network security fundamentals', 'Cybersecurity', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 7),
('Ethical Hacking', 'Penetration testing and vulnerability assessment', 'Cybersecurity', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 7),
('Cryptography Fundamentals', 'Encryption, hashing, and security protocols', 'Cybersecurity', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 7),
('React Native Basics', 'Cross-platform mobile development', 'Mobile Development', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 8),
('iOS Development with Swift', 'Native iOS app development with Swift', 'Mobile Development', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 8),
('Android Development', 'Native Android app development', 'Mobile Development', 'https://www.youtube.com/watch?v=N90ANMaQ9JM', 'https://investin.org/cdn/shop/articles/How_to_Motivate_Yourself_to_Study.jpg?v=1640183354', 8);
